/*
----------------------------------------------------------------
the script is saved into the Bronze table 
The script loads data from the CSV files into the Bronze schema.
It bulk inserts the data from CSV files into tables.
